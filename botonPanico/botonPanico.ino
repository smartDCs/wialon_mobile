...
#define WIFI_SSID "NETWORK_IFCA"
#define WIFI_PASSWORD "*IFCA*2020*"
 ...
 *
 */
#define API_KEY "AIzaSyCb0JB3GOk_wTzp1wsSK3i8lWRBZqkCQjQ"

/* 3. If work with RTDB, define the RTDB URL */
#define DATABASE_URL "https://telegrafiaec-default-rtdb.firebaseio.com/" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
